...
def draw_green_circles(image_path, output_dir, circle_positions, radius=40, color=(0, 255, 0), file_name='flaw_cheat.png'):
    ...
    input_image_path = './image/gen_maze3.png'  # 替换为您的第一张图片路径
    output_image_path = './image/'  # 替换为您希望保存的输出图片路径
...
def initial_path_example():
    ...
    # 绘制起点和终点
    ax.plot(0.1, 0.2, 'ko', markersize=5)  # 起点
    ax.plot(0.9, 0.8, 'ko', markersize=5)  # 终点
